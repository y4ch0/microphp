...
$configuredEnvFile = getenv('MICROPHP_ENV_FILE');
$envFile = is_string($configuredEnvFile) && $configuredEnvFile !== ''
    ? $configuredEnvFile
    : ROOT_PATH . '/.env';
...
// document root; framework internals are installed under vendor/ by Composer.
